import { todolistReducer, TodolistType } from '../slices/todolistSlice'
import { v1 } from 'uuid'
...
test('correct todolist should be added', () => {
  ...
  const endStateTodolists = todolistReducer(
    startStateTodolists,
    addTodolist.fulfilled(newTd, 'requestId', newTd)
  )
...
test('correct todolist should change its name', () => {
  ...
  const endStateTodolists = todolistReducer(
    startStateTodolists,
    changeTodolistTitle.fulfilled(newTd, 'requestId', newTd)
  )
